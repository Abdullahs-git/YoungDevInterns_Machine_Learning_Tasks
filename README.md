...
The tasks are organized into three levels — **Basic**, **Intermediate**, and **Expert** — each containing structured exercises and projects to demonstrate progressive learning and application of ML concepts.
...
- **Expert/** — Advanced projects showcasing model optimization, deployment, and problem-solving skills.

## Topics Covered
- Data PreprocEessing & EDA  
